...
# Validação total (incluindo as legendas e fotos)
campos_base = all([nome, cpf_valido, apto, torre, data_vis_form, dia_laudo, mes_laudo_extenso, ano_laudo, foto_capa, endereco_formatado])
...
if st.button("🚀 GERAR LAUDO COMPLETO", use_container_width=True):
    if not campos_base:
        st.warning("⚠️ Preencha todos os dados do cliente, endereço e datas.")
        ...
        try:
            ...
            dados = {
                ...
                "dia_laudo": dia_laudo,
                "mes_laudo_extenso": mes_laudo_extenso.lower(), # FORÇA MINÚSCULO AQUI
                "ano": ano_laudo,
            ...
            nome_final_doc = f"LT_{nome_limpo}.docx"
